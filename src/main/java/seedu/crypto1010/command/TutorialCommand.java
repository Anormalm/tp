...
public class TutorialCommand extends Command {
    ...
    private static final String[] tutorialMessages = {
        ...
        We will now create a private key, derive a public key from it using elliptic curve math (secp256k1), then hash that into a unique address.
        """,
        ...
        This is the blockchain's public ledger in action: every transaction is fully auditable and nothing can be quietly altered or erased.
        ...
        You've now seen the full lifecycle of a blockchain transaction: wallets, key pairs, signing, sending, fees, blocks, and validation.
